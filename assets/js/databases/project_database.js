    ...
    function new_project(title, ownerID, smallDescription, fullDescription, type, linkVideo, valor, imageArray) {
        ...
        imageArray.forEach(item => {
            ...
            upload.child(imageName).put(imageFile).then(function (a) {
                ...
                upload.child(a).getDownloadURL().then(function (url_imagem) {
                            ...
                            if (get_projects[gp].imagens) {
                                ...
                                if (get_projects[gp].imagens[0] && get_projects[gp].imagens[0].lastIndexOf('deleted') == -1) {
                                    ...
                                    lista.innerHTML += `<div class="imagem1">
                                        ...
                                        <img src="${get_projects[gp].imagens[0]}" id="${imageID}" class="image_of_project" onload="document.getElementById('${imageID}_loading').style.display = 'none'; document.getElementById('${imageID}').style.display = 'flex';">
                                    </div>`
                                ...
                                if (get_projects[gp].imagens[1] && get_projects[gp].imagens[1].lastIndexOf('deleted') == -1) {
                                    ...
                                    lista.innerHTML += `<div class="imagem1">
                                        <img src="/assets/images/Loading.gif" id="${imageID}_loading" class="image_of_loading"/>
                                        <img src="${get_projects[gp].imagens[1]}" id="${imageID}" class="image_of_project" onload="document.getElementById('${imageID}_loading').style.display = 'none'; document.getElementById('${imageID}').style.display = 'flex';">
                                    </div>`
                                ...
                                if (get_projects[gp].imagens[2] && get_projects[gp].imagens[2].lastIndexOf('deleted') == -1 && photosNum < 2) {
                                    ...
                                    lista.innerHTML += `<div class="imagem1">
                                        <img src="/assets/images/Loading.gif" id="${imageID}_loading" class="image_of_loading"/>
                                        <img src="${get_projects[gp].imagens[2]}" id="${imageID}" class="image_of_project" onload="document.getElementById('${imageID}_loading').style.display = 'none'; document.getElementById('${imageID}').style.display = 'flex';">
                                    </div>`
                                ...
                                if (get_projects[gp].imagens[3] && get_projects[gp].imagens[3].lastIndexOf('deleted') == -1 && photosNum < 2) {
                                    ...
                                    lista.innerHTML += `<div class="imagem1">
                                        <img src="/assets/images/Loading.gif" id="${imageID}_loading" class="image_of_loading"/>
                                        <img src="${get_projects[gp].imagens[3]}" id="${imageID}" class="image_of_project" onload="document.getElementById('${imageID}_loading').style.display = 'none'; document.getElementById('${imageID}').style.display = 'flex';">
                                    </div>`
