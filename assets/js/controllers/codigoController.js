...
const loading_reinvite= document.getElementById('loading-button-reenvite')
    ...
    if(enviar.style.backgroundColor != 'grey'){
        ...
        setTimeout(function(){
            ...
            if(errors > 0){
                ...
                tw.init('check_code',[codigo.value,page_type])
            }
        },500)
    }
...
reinvite.addEventListener('click', (e) => {
    ...
    if(reinvite.style.backgroundColor != 'grey'){
        ...
        setTimeout(function(){
            ...
            tw.init('open_request',[page_type,'reinvite'])
        },500)
    }
